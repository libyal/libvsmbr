...
{
	static char *function = "libvsmbr_notify_set_stream";
...
int libvsmbr_notify_stream_open(
     ...
     libcerror_error_t **error )
{
	static char *function = "libvsmbr_notify_stream_open";
...
int libvsmbr_notify_stream_close(
     libcerror_error_t **error )
{
	static char *function = "libvsmbr_notify_stream_close";
