...
#if !defined( _LIBVSMBR_LIBCTHREADS_H )
#define _LIBVSMBR_LIBCTHREADS_H

#include <common.h>

#if defined( HAVE_MULTI_THREAD_SUPPORT ) && !defined( HAVE_LOCAL_LIBVSMBR )
#define HAVE_LIBVSMBR_MULTI_THREAD_SUPPORT
#endif
...
#endif /* defined( HAVE_LIBVSMBR_MULTI_THREAD_SUPPORT ) */

#endif /* !defined( _LIBVSMBR_LIBCTHREADS_H ) */
