...
#if !defined( _VSMBRTOOLS_GETOPT_H )
#define _VSMBRTOOLS_GETOPT_H
...
typedef struct vsmbrtools_option vsmbrtools_option_t;

struct vsmbrtools_option
{
...
#define vsmbrtools_getopt( argument_count, argument_values, options_string ) \
...
system_integer_t vsmbrtools_getopt(
                  int argument_count,
...
void vsmbrtools_getopt_wrapped_fprint(
      FILE *stream,
...
void vsmbrtools_getopt_usage_fprint(
      FILE *stream,
      const char *program,
      const char *description,
      const vsmbrtools_option_t *options,
      int number_of_options );

int vsmbrtools_getopt_get_options_string(
     const vsmbrtools_option_t *options,
     int number_of_options,
...
#endif /* !defined( _VSMBRTOOLS_GETOPT_H ) */
