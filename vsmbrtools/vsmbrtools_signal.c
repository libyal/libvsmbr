...
void (*vsmbrtools_signal_signal_handler)( vsmbrtools_signal_t ) = NULL;
...
{
	static char *function = "vsmbrtools_signal_handler";
	...
	switch( signal )
	{
		...
		case CTRL_C_EVENT:
			if( vsmbrtools_signal_signal_handler != NULL )
			{
				vsmbrtools_signal_signal_handler(
				 signal );
			}
			return( TRUE );
...
{
	static char *function = "vsmbrtools_signal_attach";
	...
	vsmbrtools_signal_signal_handler = signal_handler;

	if( SetConsoleCtrlHandler(
	     (PHANDLER_ROUTINE) vsmbrtools_signal_handler,
	     TRUE ) == 0 )
	{
		libcerror_error_set(
		 error,
...
#if defined( _MSC_VER )
	vsmbrtools_signal_initialize_memory_debug();
#endif
...
int vsmbrtools_signal_detach(
     libcerror_error_t **error )
{
	static char *function = "vsmbrtools_signal_detach";
	...
	vsmbrtools_signal_signal_handler = NULL;
