...
/* Tests the libvsmbr_io_handle_initialize function
 * Returns 1 if successful or 0 if not
 */
int vsmbr_test_io_handle_initialize(
     void )
{
	...
	io_handle = (libvsmbr_io_handle_t *) 0x12345678UL;
	...
	for( test_number = 0;
	     ...
	     test_number++ )
	{
		/* Test libvsmbr_io_handle_initialize with malloc failing
		 */
	...
	for( test_number = 0;
	     ...
	     test_number++ )
	{
		/* Test libvsmbr_io_handle_initialize with memset failing
		 */
...
/* Tests the libvsmbr_io_handle_free function
 * Returns 1 if successful or 0 if not
 */
int vsmbr_test_io_handle_free(
     void )
{
	libcerror_error_t *error = NULL;
	int result               = 0;
...
/* Tests the libvsmbr_io_handle_clear function
 * Returns 1 if successful or 0 if not
 */
int vsmbr_test_io_handle_clear(
     void )
{
	libcerror_error_t *error        = NULL;
	libvsmbr_io_handle_t *io_handle = NULL;
	...
	/* Test regular cases
	 */
	result = libvsmbr_io_handle_clear(
	          io_handle,
	          &error );
	...
	/* Test libvsmbr_io_handle_clear with memset failing
	 */
...
#endif
{
	...
	VSMBR_TEST_RUN(
	 "libvsmbr_io_handle_initialize",
	 vsmbr_test_io_handle_initialize );
	...
	VSMBR_TEST_RUN(
	 "libvsmbr_io_handle_clear",
	 vsmbr_test_io_handle_clear );
