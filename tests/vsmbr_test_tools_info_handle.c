...
#include "../vsmbrtools/info_handle.h"

/* Tests the info_handle_initialize function
 * Returns 1 if successful or 0 if not
 */
int vsmbr_test_tools_info_handle_initialize(
     void )
{
 ...
 * Returns 1 if successful or 0 if not
 */
int vsmbr_test_tools_info_handle_free(
     void )
{
	libcerror_error_t *error = NULL;
	int result               = 0;
...
#endif
{
	...
	VSMBR_TEST_RUN(
	 ...
	 vsmbr_test_tools_info_handle_initialize );

	VSMBR_TEST_RUN(
	 "info_handle_free",
	 vsmbr_test_tools_info_handle_free );
