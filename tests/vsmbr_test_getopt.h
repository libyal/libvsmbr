...
#if !defined( _VSMBR_TEST_GETOPT_H )
#define _VSMBR_TEST_GETOPT_H
...
#define vsmbr_test_getopt( argument_count, argument_values, options_string ) \
...
system_integer_t vsmbr_test_getopt(
                  int argument_count,
...
#endif /* !defined( _VSMBR_TEST_GETOPT_H ) */
