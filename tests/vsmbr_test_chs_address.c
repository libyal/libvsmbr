/*
 * Library chs_address type test program
 *
 ...
 */
int vsmbr_test_chs_address_initialize(
     void )
{
	...
	chs_address = (libvsmbr_chs_address_t *) 0x12345678UL;
	...
	for( test_number = 0;
	     ...
	     test_number++ )
	{
		/* Test libvsmbr_chs_address_initialize with malloc failing
		 */
	...
	for( test_number = 0;
	     ...
	     test_number++ )
	{
		/* Test libvsmbr_chs_address_initialize with memset failing
		 */
...
/* Tests the libvsmbr_chs_address_free function
 * Returns 1 if successful or 0 if not
 */
int vsmbr_test_chs_address_free(
     void )
{
	libcerror_error_t *error = NULL;
	int result               = 0;
...
#endif
{
	...
	VSMBR_TEST_RUN(
	 "libvsmbr_chs_address_initialize",
	 vsmbr_test_chs_address_initialize );
