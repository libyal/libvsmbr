...
#if !defined( _LIBVSMBR_EXTERN_H )
#define _LIBVSMBR_EXTERN_H

/* To export functions from the libvsmbr DLL define LIBVSMBR_DLL_EXPORT
 * To import functions from the libvsmbr DLL define LIBVSMBR_DLL_IMPORT
